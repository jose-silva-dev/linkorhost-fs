...
export const siteConfig = {
			...
			plans: [
				{
					...
					specs: "2 vCPU • 4GB RAM DDR5 • 40GB NVMe",
					price: "59,94",
					color: "#3B82F6",
				},
				{
					...
					specs: "4 vCPU • 8GB RAM DDR5 • 60GB NVMe",
					price: "119,94",
					color: "#3B82F6",
				},
				{
					...
					specs: "6 vCPU • 12GB RAM DDR5 • 80GB NVMe",
					price: "179,94",
					color: "#3B82F6",
				},
			],
	...
	categories: [
		{
			...
			count: "+20 milhões",
			description:
				"Fotos, vetores, vídeos, PSDs e modelos gráficos prontos para usar.",
		},
		{
			title: "MODELOS, FONTES E ÁUDIOS",
			count: "+900.000",
			description:
				"Bibliotecas completas com apresentações, vídeos, fontes e elementos 3D.",
		},
		{
	...
	googleReviews: {
		...
		Solution: "100%",
		description:
			"A Linkor demonstra excelência no atendimento ao cliente, nenhuma reclamação nos últimos 3 anos.",
